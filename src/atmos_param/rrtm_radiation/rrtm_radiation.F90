...
!------------ allocate arrays to be used later  -------
          ...
          ! mml looks like they have gotten fancier with if they should allocate memory for stuff or not. I'm just going to allocate
          ! memory for mine all the time - bad coding form, less efficient, but fewer things to break!
...
! Modules
          use rrtm_vars,only:         sw_flux,lw_flux,zencos,tdt_rad,tdt_sw_rad,tdt_lw_rad,t_half,&
									  ...
									  &id_olr,id_toa_sw,olr,toa_sw, id_half_level_temp,
                                                                  id_full_level_temp, &
