...
!---------------------------------------------------------------------------------------------------------------
        ...
        namelist/rrtm_radiation_nml/ include_secondary_gases, do_read_ozone, ozone_file, input_o3_file_is_mmr, &
             ...
             &solday, equinox_day,solr_cnst !,mml_co2
...
! In/Out variables
          ...
          ! MML radiative fluxes
          ! nope, defined them elsewhere, don't do it here
          !real(kind=rb),allocatable,dimension(:,:)   :: mml_fsds, mml_fsns, mml_fsus, mml_flds, mml_flus, mml_flns, mml_solin  
