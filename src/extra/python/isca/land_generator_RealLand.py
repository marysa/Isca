...
def write_land(exp,land_mode='continents',continents=['all'],mountains='all',topo_mode='sauliere2012',waterworld=False):
...
# Next produce a topography array
    ...
    topo_filename = GFDL_BASE + '/exp/' + exp + '/input/RealLand_land.nc'
