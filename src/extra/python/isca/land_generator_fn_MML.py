...
def write_land(exp,land_mode='square',boundaries=[0.,90.,0.,360.],continents=['all'],topo_mode='none',mountains=['all'],topo_gauss=[40.,40.,20.,0.,0.],waterworld=False):
...
# Next produce a topography array
    ...
    #topo_filename = GFDL_BASE + '/exp/' + exp + '/input/' + exp +'_land.nc'
    topo_filename = '/global/home/users/mlague/ISCA/Isca/input/land_masks/' + exp + '_land.nc'
    #topo_filename = '/home/disk/eos18/mlague/ISCA/iscaruns/forcing_files/' + exp + '_' + 'land.nc'
...
if __name__ == "__main__":
    ...
    #write_land('test',land_mode='square',boundaries=[0.,90.,-1.,360.],topo_mode='none',)
    #write_land('terra',land_mode='square',boundaries=[-90,90.,-1.,360.],topo_mode='none',)
    #write_land('PolarCapSouth',land_mode='square',boundaries=[-90,-30.,-1.,360.],topo_mode='none',)
    #write_land('PolarCapNorth',land_mode='square',boundaries=[30,90.,-1.,360.],topo_mode='none',)
    #write_land('LandBelt',land_mode='square',boundaries=[-30,30.,-1.,360.],topo_mode='none',)
    #write_land('Aqua',land_mode='square',boundaries=[0.,0.,0.,0.],topo_mode='none',)
    #write_land('realworld',land_mode='continents',continents=['all'],topo_mode='sauliere2012',mountains=['all'],waterworld=False)
    #write_land('NorthWestLand',land_mode='square',boundaries=[0.,90.,180.,360.],topo_mode='none',)
    #write_land('NorthWestWestLand',land_mode='square',boundaries=[0.,90.,270.,360.],topo_mode='none',)
    write_land('NorthEastWestLand',land_mode='square',boundaries=[0.,90.,90.,180.],topo_mode='none',)
